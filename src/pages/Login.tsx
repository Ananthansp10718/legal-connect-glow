      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-blue-900 via-purple-900 to-blue-800">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white p-8">
            ...
            <p className="text-xl opacity-90">Secure access to legal expertise – anytime, anywhere.</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass-card rounded-2xl p-8 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Welcome back to LegalConnect</p>
            </div>
            ...
            <form className="space-y-6">
              ...
              <div className="text-right">
                <Link to="/forgot-password" className="text-blue-600 hover:text-blue-800 text-sm font-medium hover:underline transition-colors">
                  Forgot password?
                </Link>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white/50 text-gray-500">OR</span>
                </div>
              </div>
              ...
              <Button
                variant="outline"
                className="w-full h-12 bg-white/70 border-gray-300 hover:bg-white/90 transition-all duration-300 hover:scale-105"
              >
              ...
              <div className="text-center">
                <p className="text-gray-600">
                  ...
                  <Link to="/signup" className="text-blue-600 hover:text-blue-800 font-semibold hover:underline transition-colors">
                    Create one
                  </Link>
                </p>
              </div>
