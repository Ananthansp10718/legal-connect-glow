      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-blue-900 via-purple-900 to-blue-800">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white p-8">
            <h1 className="text-4xl font-bold mb-4">Your legal solution starts here</h1>
            <p className="text-xl opacity-90">Trusted lawyers. Real advice.</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass-card rounded-2xl p-8 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Join LegalConnect today</p>
            </div>
            ...
            <form className="space-y-6">
              ...
              <Button className="w-full h-12 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                Create Account
              </Button>
